...
print("[-] Script Deface Creator\n[-] Coded By : NumeX\n[-] Help By : Sampari-Senpai\n")

namasc = input("[~] Masukan Nama Script - Contoh (NumeX.html) : ")
title = input("[~] Judul title - Contoh (NumeX Ganteng) : ")
heading = input("[~] Hacked by - ContoCh (Hacked By K0NT0L): ")
imagelink = input("[~] link gambar (tengah) : ")
bgimage = input("[~] link gambar (background) : ")
message = input("[~] Pesan. gunakan kode <br> untuk text selanjutnya! - Contoh (Asw<br>Ngentd) : ")
textcolor = input("[~] Warna text - Contoh (yellow) : ")
youtubeid = input("[~] Youtube ID [MUSIC] - Contoh (4eaXoebXKfY) : ")


#Open the index
fo = open(str(namasc), "w")
